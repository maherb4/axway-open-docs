...
|---------    |YAML configuration store (GA)              |INSTALL_DIR/apigateway folder permissions changed                  |---                  |---         |
|---------    |Support for MariaDB 10.5               |---                  |MariaDB 5.5                  |---         |
|---------    |New SHA-256 hash algorithm option on SFTP server fingerprint check               |---                  |SFTP server fingerprint check (MD5 hash algorithm)                 |---         |
|---------    |Replacement of MD5 hashed API Gateway configuration files with SHA256              |---                  |---                  |---         |
|---------    |Changes to JWT Verify filter              |---                  |---                  |---         |
|---------    |Analytics CSP Header change              |---                  |---                  |---         |
|---------    |Authorization records threshold added              |---                  |---                  |---         |
